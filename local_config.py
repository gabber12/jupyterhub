...
c.GitHubOAuthenticator.oauth_callback_url = 'http://localhost:8002/hub/oauth_callback'
c.GitHubOAuthenticator.client_id = '22348fef6847c4f7bf10'
c.GitHubOAuthenticator.client_secret = 'e49950ba492f3d1d402b57f80f23c7dc8f8e5be4'
c.Authenticator.admin_users = {'gabber12'}
c.Authenticator.whitelist = {'gabber12'}
...
c.MarathonSpawner.marathon_host = 'http://stg-appmesosm101.phonepe.nm2:8080'
c.MarathonSpawner.mem_limit = '2G'
c.MarathonSpawner.cpu_limit = 1
c.MarathonSpawner.app_image = 'jupyter/base-notebook:lab-1.2.1'
